...
////////////////////////////////////
$lovedones = "CREATE TABLE IF NOT EXISTS lovedones
(
loveid INT(11) NOT NULL AUTO_INCREMENT,
userid INT(11) NOT NULL,
lovedone VARCHAR(16) NOT NULL,
FOREIGN KEY (userid) REFERENCES users(id),
PRIMARY KEY (loveid)
)";
$query = mysqli_query($db_conx, $lovedones); 
if ($query === TRUE) {
  echo "<h3>lovedones table created OK :) </h3>"; 
} else {
  echo "<h3>lovedones table NOT created :( </h3>"; 
}
////////////////////////////////////
